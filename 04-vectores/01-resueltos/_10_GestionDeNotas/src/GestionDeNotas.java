...
public class GestionDeNotas {
    public static void main(String[] args) {
        ...
        float primer_trim[],
                segundo_trim[], tercer_trim[], nota, sum_1trim = 0, sum_2trim = 0, sum_3trim = 0, prom_est_n = 0;
        int est_pos;
        ...
        for (int i = 0; i < 4; i++) {
            System.out.print("Nota estudiante " + (i + 1) + ", 1er Trim: ");
            nota = teclado.nextFloat();
            primer_trim[i] = nota;
            sum_1trim += nota;
            System.out.print("Nota estudiante " + (i + 1) + ", 2do Trim: ");
            nota = teclado.nextFloat();
            segundo_trim[i] = nota;
            sum_2trim += nota;
            System.out.print("Nota estudiante " + (i + 1) + ", 3er Trim: ");
            nota = teclado.nextFloat();
            tercer_trim[i] = nota;
            sum_3trim += nota;
        }
        ...
        System.out.println("Promedio notas 1er Trim: " + (sum_1trim / 4));
        System.out.println("Promedio notas 2do Trim: " + (sum_2trim / 4));
        System.out.println("Promedio notas 3er Trim: " + (sum_3trim / 4));
        System.out.println("Nota final Est. N: " + prom_est_n);
    }
}
